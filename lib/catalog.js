...
export function createCatalog({ dataDir, baseUrl = 'https://musicforprogramming.net', fetchImpl = fetch, concurrency = 4, log = () => {} }) {
  if (!dataDir) throw new Error('dataDir is required');
  const file = path.join(dataDir, 'episodes.json');
